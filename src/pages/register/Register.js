            ...
            <div className="pt-5 flex flex-wrap align-items-center justify-content-center">
                <div className="surface-card p-4 shadow-2 border-round w-full md:w-8 lg:w-6">
                    ...
                    <div>
                        ...
                        <InputText id="firstName" type="text" placeholder="First Name" className="w-full mb-3" 
                            value={firstName}
                            onChange={e => setFirstName(e.target.value)}/>
                        
                        <label htmlFor="lastName" className="block text-900 font-medium mb-2">Last Name:</label>
                        <InputText id="lastName" type="text" placeholder="Last Name" className="w-full mb-3" 
                            value={lastName}
